...
We propose to do this by taking advantage of several theories in learning, most notably the Teacher's Dilema and Space Repitition, to create a framework where we will utilize peer tutoring techniques to determine what are the appropriate "next" questions and what questions should be asked to make sure the students are retaining the information.
